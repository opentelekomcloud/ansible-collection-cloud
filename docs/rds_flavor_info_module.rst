...
.. _ansible_collections.opentelekomcloud.cloud.rds_flavor_info_module:
...
opentelekomcloud.cloud.rds_flavor_info -- Get RDS flavor info
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.rds_flavor_info`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-instance_mode"></div>
                    <b>instance_mode</b>
                    <a class="ansibleOptionLink" href="#parameter-instance_mode" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-rds_flavors"></div>
                    <b>rds_flavors</b>
                    <a class="ansibleOptionLink" href="#return-rds_flavors" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-rds_flavors/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-rds_flavors/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-rds_flavors/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-rds_flavors/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
