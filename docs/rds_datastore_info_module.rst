...
.. _ansible_collections.opentelekomcloud.cloud.rds_datastore_info_module:
...
opentelekomcloud.cloud.rds_datastore_info -- Get supported RDS datastore versions
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.rds_datastore_info`.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-rds_datastore_versions"></div>
                    <b>rds_datastore_versions</b>
                    <a class="ansibleOptionLink" href="#return-rds_datastore_versions" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>On Success.</td>
                <td>
                                            <div>List of dictionaries describing RDS datastore version.</div>
                                        <br/>
                                    </td>
            </tr>
                                        <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-rds_datastore_versions/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-rds_datastore_versions/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-rds_datastore_versions/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-rds_datastore_versions/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
