...
.. _ansible_collections.opentelekomcloud.cloud.loadbalancer_module:
...
opentelekomcloud.cloud.loadbalancer -- Add/Delete load balancer from OpenTelekomCloud
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.loadbalancer`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-auto_public_ip"></div>
                    <b>auto_public_ip</b>
                    <a class="ansibleOptionLink" href="#parameter-auto_public_ip" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Allocate a public IP address and associate with the VIP automatically.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">raw</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-delete_public_ip"></div>
                    <b>delete_public_ip</b>
                    <a class="ansibleOptionLink" href="#parameter-delete_public_ip" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>When <code>state=absent</code> and this option is true, any public IP address associated with the VIP will be deleted along with the load balancer.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name that has to be given to the load balancer</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-public_ip_address"></div>
                    <b>public_ip_address</b>
                    <a class="ansibleOptionLink" href="#parameter-public_ip_address" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>Public IP address associated with the VIP.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-vip_address"></div>
                    <b>vip_address</b>
                    <a class="ansibleOptionLink" href="#parameter-vip_address" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>IP address of the load balancer virtual IP.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-vip_subnet"></div>
                    <b>vip_subnet</b>
                    <a class="ansibleOptionLink" href="#parameter-vip_subnet" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>The name or id of the subnet for the virtual IP of the load balancer. One of <em>vip_network</em>, <em>vip_subnet</em>, or <em>vip_port</em> must be specified for creation.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>If the module should wait for the load balancer to be created or deleted.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                            <div>The load balancer UUID.</div>
                                        <br/>
                ...
                <td>On success when <code>state=present</code></td>
                <td>
                                            <div>Dictionary describing the load balancer.</div>
                                        <br/>
                                    </td>
            </tr>
                                        <tr>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/is_admin_state_up"></div>
                    <b>is_admin_state_up</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/is_admin_state_up" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/listeners"></div>
                    <b>listeners</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/listeners" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/operating_status"></div>
                    <b>operating_status</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/operating_status" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/pools"></div>
                    <b>pools</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/pools" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                       / <span style="color: purple">elements=string</span>                    </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/provisioning_status"></div>
                    <b>provisioning_status</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/provisioning_status" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/public_vip_address"></div>
                    <b>public_vip_address</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/public_vip_address" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/vip_address"></div>
                    <b>vip_address</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/vip_address" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/vip_network_id"></div>
                    <b>vip_network_id</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/vip_network_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Network ID the load balancer virutal IP port belongs in.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/vip_port_id"></div>
                    <b>vip_port_id</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/vip_port_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-loadbalancer/vip_subnet_id"></div>
                    <b>vip_subnet_id</b>
                    <a class="ansibleOptionLink" href="#return-loadbalancer/vip_subnet_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Subnet ID the load balancer virutal IP port belongs in.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
