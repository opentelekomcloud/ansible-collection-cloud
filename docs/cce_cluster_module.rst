...
.. _ansible_collections.opentelekomcloud.cloud.cce_cluster_module:
...
opentelekomcloud.cloud.cce_cluster -- Add/Delete CCE Cluster
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.cce_cluster`.
...
- Add or Remove CCE Cluster in OTC service(ELB).
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name or ID of the Neutron router</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster"></div>
                    <b>cce_cluster</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
