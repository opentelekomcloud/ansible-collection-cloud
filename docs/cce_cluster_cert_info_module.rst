...
.. _ansible_collections.opentelekomcloud.cloud.cce_cluster_cert_info_module:
...
opentelekomcloud.cloud.cce_cluster_cert_info -- Get Certificates of a CCE cluster
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.cce_cluster_cert_info`.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster_certs"></div>
                    <b>cce_cluster_certs</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster_certs" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>On Success.</td>
                <td>
                                            <div>Dictionary containing cluster certificates.</div>
                                        <br/>
                                    </td>
            </tr>
                                        <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster_certs/ca"></div>
                    <b>ca</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster_certs/ca" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Authority Certificate content.</div>
                                        <br/>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster_certs/client_certificate"></div>
                    <b>client_certificate</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster_certs/client_certificate" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Client Certificate content.</div>
                                        <br/>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster_certs/client_key"></div>
                    <b>client_key</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster_certs/client_key" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Private key for Client Certificate.</div>
                                        <br/>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-cce_cluster_certs/context"></div>
                    <b>context</b>
                    <a class="ansibleOptionLink" href="#return-cce_cluster_certs/context" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Dictionary with the certificate context information.</div>
                                        <br/>
                                    </td>
            </tr>
