...
.. _ansible_collections.opentelekomcloud.cloud.nat_snat_rule_module:
...
opentelekomcloud.cloud.nat_snat_rule -- Manage NAT SNAT rule instances
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.nat_snat_rule`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Specifies a subset of the VPC subnet CIDR block or</div>
                                            <div>a CIDR block of Direct Connect connection.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Address or ID of the floating IP where the SNAT rule is attached to.</div>
                                            <div>Mandatory for SNAT rule creation</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>ID of the NAT SNAT rule</div>
                                            <div>Mandatory for SNAT rule deletion</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>ID or Name of the network for the SNAT rule.</div>
                                            <div>Mandatory for SNAT rule creation</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>0 Either network_id or cidr can be specified in VPC</div>
                                            <div>1 only cidr can be specified over a Direct Connect connection.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-snat_rule"></div>
                    <b>snat_rule</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>On Success.</td>
                <td>
                                            <div>Dictionary describing the SNAT rule.</div>
                                        <br/>
                                    </td>
            </tr>
                                        <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/admin_state_up"></div>
                    <b>admin_state_up</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/admin_state_up" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Specifies whether gateway is up or down.</div>
                                        <br/>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/cidr"></div>
                    <b>cidr</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/cidr" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">192.168.1.10/32</div>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/created_at"></div>
                    <b>created_at</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/created_at" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Creation time of the NAT SNAT rule</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/floating_ip_address"></div>
                    <b>floating_ip_address</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/floating_ip_address" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Address of the floating IP</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">e1029c97-639e-4481-9254-f30c5632b123&quot;</div>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/floating_ip_id"></div>
                    <b>floating_ip_id</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/floating_ip_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>ID of the floating IP address</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">e1029c97-639e-4481-9254-f30c5632b123</div>
                                    </td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                        ...
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">3fea684b-50f1-4613-967a-a7bed5e59123</div>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/nat_gateway_id"></div>
                    <b>nat_gateway_id</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/nat_gateway_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>ID of the attached NAT gateway</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/network_id"></div>
                    <b>network_id</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/network_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Network ID of the subnet where the NAT SNAT rule</div>
                                            <div>points to.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">25d24fc8-d019-4a34-9fff-0a09fde6a567</div>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/source_type"></div>
                    <b>source_type</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/source_type" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/status"></div>
                    <b>status</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/status" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-snat_rule/tenant_id"></div>
                    <b>tenant_id</b>
                    <a class="ansibleOptionLink" href="#return-snat_rule/tenant_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Project ID where the NAT SNAT rule is located in.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">25d24fc8-d019-4a34-9fff-0a09fde6a567</div>
                                    </td>
