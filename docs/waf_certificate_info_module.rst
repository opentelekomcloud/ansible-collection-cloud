...
.. _ansible_collections.opentelekomcloud.cloud.waf_certificate_info_module:
...
opentelekomcloud.cloud.waf_certificate_info -- Get WAF certificate info
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.waf_certificate_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name or ID of the certificate.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-waf_certificate_info"></div>
                    <b>waf_certificate_info</b>
                    <a class="ansibleOptionLink" href="#return-waf_certificate_info" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>On Success.</td>
                <td>
                                            <div>List of dictionaries describing Certificates matching query.</div>
                                        <br/>
                                    </td>
            </tr>
                                        <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-waf_certificate_info/expire_time"></div>
                    <b>expire_time</b>
                    <a class="ansibleOptionLink" href="#return-waf_certificate_info/expire_time" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-waf_certificate_info/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-waf_certificate_info/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-waf_certificate_info/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-waf_certificate_info/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-waf_certificate_info/timestamp"></div>
                    <b>timestamp</b>
                    <a class="ansibleOptionLink" href="#return-waf_certificate_info/timestamp" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                                          </div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>Certificate upload timestamp</div>
                                        <br/>
                                    </td>
            </tr>
