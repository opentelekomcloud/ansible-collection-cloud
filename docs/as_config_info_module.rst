...
.. _ansible_collections.opentelekomcloud.cloud.as_config_info_module:
...
opentelekomcloud.cloud.as_config_info -- Get AutoScaling configs
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.as_config_info`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>ID of the image to filter results.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-as_configs"></div>
                    <b>as_configs</b>
                    <a class="ansibleOptionLink" href="#return-as_configs" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>On Success.</td>
                <td>
                                            <div>List of dictionaries describing AutoScaling Configs.</div>
                                        <br/>
                                    </td>
            </tr>
                                        <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-as_configs/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-as_configs/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-as_configs/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-as_configs/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
