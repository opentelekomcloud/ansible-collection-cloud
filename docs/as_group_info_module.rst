...
.. _ansible_collections.opentelekomcloud.cloud.as_group_info_module:
...
opentelekomcloud.cloud.as_group_info -- Get AutoScaling groups
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`opentelekomcloud.cloud.as_group_info`.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-as_groups"></div>
                    <b>as_groups</b>
                    <a class="ansibleOptionLink" href="#return-as_groups" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-as_groups/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-as_groups/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-as_groups/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-as_groups/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
