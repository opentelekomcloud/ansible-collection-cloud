  ...
  provisioning_status:
    description:
      - Specifies the provisioning status of the load balancer.
        The value can only be ACTIVE, indicating that the load balancer
...
class LoadbalancerV3InfoModule(OTCModule):
    argument_spec = dict(
        ...
        eips=dict(required=False, type='list', elements='str'),
        ...
        publicips=dict(required=False, type='list', elements='str'),
