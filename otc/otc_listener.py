...
---
module: otc_listener
short_description: Add/Delete a listener for a load balancer from OpenTelkomCloud
extends_documentation_fragment: openstack
version_added: "2.8"
author: "Artem Goncharov (@gtema)"
description:
   - Add or Remove a listener for a load balancer from the OTC load-balancer service.
options:
   name:
     description:
...
def main():
    ...
    try:
        changed = False
        listener = cloud.network.find_listener(
        ...
        if module.params['state'] == 'present':
            if not listener:
                ...
                listener = cloud.network.create_listener(
            ...
            if not listener:
                ...
                cloud.network.delete_listener(listener)
                changed = True
