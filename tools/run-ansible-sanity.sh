...
mkdir -p ${ANSIBLE_COLLECTIONS_PATH}/ansible_collections/opentelekomcloud/cloud
cp -a ${TOXDIR}/{plugins,tests,docs} ${ANSIBLE_COLLECTIONS_PATH}/ansible_collections/opentelekomcloud/cloud
cd ${ANSIBLE_COLLECTIONS_PATH}/ansible_collections/opentelekomcloud/cloud/
